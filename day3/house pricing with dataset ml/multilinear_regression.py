...
df = pd.read_csv('house pricing with dataset ml/housing1_prices - Sheet1.csv')
...
plt.tight_layout()
plt.savefig('house pricing with dataset ml/house_price_analysis.png', dpi=300, bbox_inches='tight')
